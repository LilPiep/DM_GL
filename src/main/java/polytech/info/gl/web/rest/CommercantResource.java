...
/**
 * REST controller for managing {@link polytech.info.gl.domain.Commercant}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CommercantResource {
    ...
    public ResponseEntity<Commercant> updateCommercant(
        ...
        @Valid @RequestBody Commercant commercant
    ...
    public ResponseEntity<Commercant> partialUpdateCommercant(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody Commercant commercant
    ) throws URISyntaxException {
        ...
        Optional<Commercant> result = commercantRepository
            ...
            .map(existingCommercant -> {
                if (commercant.getCommercantID() != null) {
                    existingCommercant.setCommercantID(commercant.getCommercantID());
                }
                if (commercant.getCommercantType() != null) {
                    existingCommercant.setCommercantType(commercant.getCommercantType());
                }
                if (commercant.getShopUrl() != null) {
                    existingCommercant.setShopUrl(commercant.getShopUrl());
                }
