...
/**
 * REST controller for managing {@link polytech.info.gl.domain.Cooperative}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CooperativeResource {
    ...
    public ResponseEntity<Cooperative> updateCooperative(
        ...
        @RequestBody Cooperative cooperative
    ...
    public ResponseEntity<Cooperative> partialUpdateCooperative(
        ...
        Optional<Cooperative> result = cooperativeRepository
            ...
            .map(existingCooperative -> {
                if (cooperative.getCooperativeName() != null) {
                    existingCooperative.setCooperativeName(cooperative.getCooperativeName());
                }
