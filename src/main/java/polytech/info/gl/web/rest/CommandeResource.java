...
/**
 * REST controller for managing {@link polytech.info.gl.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Commande> partialUpdateCommande(
        ...
        Optional<Commande> result = commandeRepository
            ...
            .map(existingCommande -> {
                ...
                if (commande.getMeansOfPayment() != null) {
                    existingCommande.setMeansOfPayment(commande.getMeansOfPayment());
                }
                if (commande.getDeadline() != null) {
                    existingCommande.setDeadline(commande.getDeadline());
                }
                if (commande.getPrice() != null) {
