      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('blogApp.cooperative.cooperativeName')" for="cooperative-cooperativeName"
            ...
            <input
              ...
              id="cooperative-cooperativeName"
              data-cy="cooperativeName"
              :class="{ valid: !$v.cooperative.cooperativeName.$invalid, invalid: $v.cooperative.cooperativeName.$invalid }"
              v-model="$v.cooperative.cooperativeName.$model"
            />
          </div>
        </div>
        <div>
