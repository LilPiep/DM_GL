    ...
    <div class="col-8">
      <div v-if="cooperative">
        <h2 class="jh-entity-heading" data-cy="cooperativeDetailsHeading">
          <span v-text="$t('blogApp.cooperative.detail.title')">Cooperative</span> {{ cooperative.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('blogApp.cooperative.cooperativeName')">Cooperative Name</span>
          </dt>
          <dd>
            <span>{{ cooperative.cooperativeName }}</span>
          </dd>
        </dl>
