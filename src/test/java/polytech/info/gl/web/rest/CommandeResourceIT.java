...
import polytech.info.gl.repository.CommandeRepository;
...
class CommandeResourceIT {
    ...
    private static final Long DEFAULT_COMMANDE_ID = 1L;
    private static final Long UPDATED_COMMANDE_ID = 2L;

    private static final Paiement DEFAULT_MEANS_OF_PAYMENT = Paiement.CB;
    private static final Paiement UPDATED_MEANS_OF_PAYMENT = Paiement.Mastercard;
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande()
            .commandeID(DEFAULT_COMMANDE_ID)
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande()
            .commandeID(UPDATED_COMMANDE_ID)
    ...
    void createCommande() throws Exception {
        ...
        assertThat(testCommande.getCommandeID()).isEqualTo(DEFAULT_COMMANDE_ID);
        assertThat(testCommande.getMeansOfPayment()).isEqualTo(DEFAULT_MEANS_OF_PAYMENT);
        assertThat(testCommande.getDeadline()).isEqualTo(DEFAULT_DEADLINE);
    ...
    @Test
    @Transactional
    void checkCommandeIDIsRequired() throws Exception {
        int databaseSizeBeforeTest = commandeRepository.findAll().size();
        // set the field null
        commande.setCommandeID(null);
    ...
    @Test
    @Transactional
    void checkMeansOfPaymentIsRequired() throws Exception {
        int databaseSizeBeforeTest = commandeRepository.findAll().size();
        // set the field null
        commande.setMeansOfPayment(null);
    ...
    void getAllCommandes() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.[*].commandeID").value(hasItem(DEFAULT_COMMANDE_ID.intValue())))
    ...
    void getCommande() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.commandeID").value(DEFAULT_COMMANDE_ID.intValue()))
    ...
    void putExistingCommande() throws Exception {
        ...
        Commande testCommande = commandeList.get(commandeList.size() - 1);
        assertThat(testCommande.getCommandeID()).isEqualTo(UPDATED_COMMANDE_ID);
        assertThat(testCommande.getMeansOfPayment()).isEqualTo(UPDATED_MEANS_OF_PAYMENT);
        assertThat(testCommande.getDeadline()).isEqualTo(UPDATED_DEADLINE);
    ...
    void partialUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.commandeID(UPDATED_COMMANDE_ID).price(UPDATED_PRICE);
