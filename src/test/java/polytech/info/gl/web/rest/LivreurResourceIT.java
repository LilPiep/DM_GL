...
import polytech.info.gl.repository.LivreurRepository;
...
class LivreurResourceIT {
    ...
    public static Livreur createEntity(EntityManager em) {
        Livreur livreur = new Livreur().livreurName(DEFAULT_LIVREUR_NAME).livreurID(DEFAULT_LIVREUR_ID);
        return livreur;
    }
    ...
    public static Livreur createUpdatedEntity(EntityManager em) {
        Livreur livreur = new Livreur().livreurName(UPDATED_LIVREUR_NAME).livreurID(UPDATED_LIVREUR_ID);
        return livreur;
    }
    ...
    void putExistingLivreur() throws Exception {
        ...
        updatedLivreur.livreurName(UPDATED_LIVREUR_NAME).livreurID(UPDATED_LIVREUR_ID);
    ...
    void partialUpdateLivreurWithPatch() throws Exception {
        ...
        partialUpdatedLivreur.livreurName(UPDATED_LIVREUR_NAME);
    ...
    void fullUpdateLivreurWithPatch() throws Exception {
        ...
        partialUpdatedLivreur.livreurName(UPDATED_LIVREUR_NAME).livreurID(UPDATED_LIVREUR_ID);
