...
describe('Commercant e2e test', () => {
  ...
  const commercantSample = { commercantID: 46458 };
  ...
  describe('new Commercant page', () => {
    ...
    it('should create an instance of Commercant', () => {
      cy.get(`[data-cy="commercantID"]`).type('78909').should('have.value', '78909');

      cy.get(`[data-cy="commercantType"]`).type('c Dollar').should('have.value', 'c Dollar');

      cy.get(`[data-cy="shopUrl"]`).type('Table Tuna').should('have.value', 'Table Tuna');
